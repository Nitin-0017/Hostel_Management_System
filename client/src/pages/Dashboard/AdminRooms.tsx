...
import type { IAdminRoom, IAdminStudent } from "../../services/adminService";
...
const AdminRooms: React.FC = () => {
  ...
  const handleAllocate = async () => {
    if (!allocateRoomId || !allocateStudentId) return;
    setAllocating(true);
    try {
      await adminService.allocateRoom(allocateStudentId, allocateRoomId);
          ...
          <div className="modal-overlay" onClick={() => setAllocateRoomId(null)}>
            <div className="modal-card" onClick={(e) => e.stopPropagation()}>
              ...
              <p style={{ marginBottom: "1rem", fontSize: "0.9rem", color: "var(--color-textSecondary)" }}>
                Select an unallocated student to assign to this room.
              </p>
              <select
              ...
              <div className="form-actions" style={{ marginTop: "1rem" }}>
                ...
                <button className="primary-btn" onClick={handleAllocate} disabled={!allocateStudentId || allocating}>
